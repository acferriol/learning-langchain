...
def get_weather(
    ...
    date: Annotated[
        str, Field(description="Fecha (YYYY-MM-DD) para la que se quiere el clima.")
    ],
) -> dict:
...
def get_activities(
    ...
    date: Annotated[
        str, Field(description="Fecha (YYYY-MM-DD) para obtener actividades.")
    ],
) -> list[dict]:
...
def find_recipes(
    query: Annotated[
        str, Field(description="Consulta del usuario o comida/ingrediente deseado")
    ],
) -> list[dict]:
        ...
        recipes = [
            {
                ...
                "steps": [
                    "Cortar el tofu en cubos.",
                    "Saltear las verduras y el tofu.",
                ],
            }
        ]
    else:
